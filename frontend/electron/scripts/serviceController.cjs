/**
 * serviceController.cjs — thin, never-throwing wrapper around the Windows SCM
...
async function start({ timeoutMs = 30_000 } = {}) {
...
async function restart({ timeoutMs = 40_000 } = {}) {
 ...
 */
async function repair({ timeoutMs = 180_000 } = {}) {
...
module.exports = { queryState, isInstalled, waitForState, start, stop, restart, repair, diagnostics };
